...
func NewDeleteCmd(f *cmdutil.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "delete <proxy>",
		Short: "Delete an MCP proxy",
		Long:  "Delete an MCP proxy by its UUID or handle.",
...
func runDelete(ctx context.Context, o *DeleteOptions) error {
	...
	if !o.Yes {
		...
		if err := o.Prompter.ConfirmDeletion(o.Proxy); err != nil {
	...
	resp, err := client.DeleteMCPProxyWithResponse(ctx, o.Org, o.Proxy)
	if err != nil {
	...
	if resp.HTTPResponse == nil || resp.HTTPResponse.StatusCode != http.StatusNoContent {
		return render.Error(o.IO, o.Scope, cmdutil.ErrorFromServer(resp.HTTPResponse, cmdutil.FirstNonNil(resp.JSON400, resp.JSON401, resp.JSON404, resp.JSON409, resp.JSON500)))
	}

	if o.IO.JSON {
		return render.JSONSuccess(o.IO, o.Scope, DeleteResult{Name: o.Proxy, Deleted: true})
	}

	cs := o.IO.StderrColorScheme()
	fmt.Fprintf(o.IO.ErrOut, "%s Deleted MCP proxy %s\n", cs.SuccessIcon(), o.Proxy)
	return nil
}
